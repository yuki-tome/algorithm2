...
void strassen(int **A, int **B, int **C, int size) {
    ...
    X = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    Y = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    P1 = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    P2 = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    P3 = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    P4 = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    P5 = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    P6 = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    P7 = (int **)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    for(i = 0; i < mid; i++) {
        X[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
        Y[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
        P1[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
        P2[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
        P3[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
        P4[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
        P5[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
        P6[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
        P7[i] = (int *)malloc(mid * sizeof(int *)/* [ Complete Here!! ] */);
    }
